          ...
          >
            <div className="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-secondary-light [&::-webkit-scrollbar-thumb]:bg-primary-light">
              <div className="py-2 md:py-0 flex flex-col md:flex-row md:items-center md:justify-end gap-0.5 md:gap-1">
                ...
                <a
                  className="p-2 flex items-center text-sm text-foreground hover:text-primary-dark focus:text-primary-dark"
                  href="#"
                >
                  <svg
                    className="shrink-0 size-4 me-3 md:me-2 block md:hidden"
                ...
                <div className="hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none] [--is-collapse:true] md:[--is-collapse:false]">
                  <button
                    ...
                    type="button"
                    className="hs-dropdown-toggle w-full p-2 flex items-center text-sm text-foreground hover:text-primary-dark focus:text-primary-dark"
                    aria-haspopup="menu"
                    aria-expanded="false"
                    aria-label="Dropdown"
                  >
                  ...
                  <div
                    className="
                      ...
                      duration-[0.1ms] md:duration-[150ms]
                      hs-dropdown-open:opacity-100
                      opacity-0
                      relative w-full md:w-52 hidden z-10 top-full
                      ps-7 md:ps-0
                      md:bg-background
                      md:rounded-lg
                      md:shadow-md
                      before:absolute before:-top-4 before:start-0
                      before:w-full before:h-5
                      md:after:hidden
                      after:absolute after:top-1 after:start-[18px]
                      after:w-0.5 after:h-[calc(100%-0.25rem)]
                  ...
                  >
                    <div className="py-1 md:px-1 space-y-0.5">
                      <a
                        className="py-1.5 px-2 flex items-center text-sm text-foreground hover:text-primary-dark focus:text-primary-dark"
                        href="#"
                      >
                        About
                      </a>
                      ...
                      <div className="hs-dropdown [--strategy:static] md:[--strategy:absolute] [--adaptive:none] md:[--trigger:hover] [--is-collapse:true] md:[--is-collapse:false] relative">
                        ...
                        <div
                          className="
                            ...
                            hidden z-10
                            md:mt-2 md:!mx-[10px]
                            md:top-0 md:end-full
                            ps-7 md:ps-0
                            md:bg-background
                            md:rounded-lg
                            md:shadow-md
                            before:hidden md:before:block
                            before:absolute before:-end-5 before:top-0
                ...
                {/* Button Group */}
                <div className="relative flex flex-wrap items-center gap-x-1.5 md:ps-2.5 md:ms-1.5 before:block before:absolute before:top-1/2 before:-start-px before:w-px before:h-4 before:bg-secondary-dark before:-translate-y-1/2">
                  <a
                    className="p-2 w-full flex items-center text-sm text-foreground hover:text-primary-dark focus:text-primary-dark"
                    href="#"
                  >
                    <svg
